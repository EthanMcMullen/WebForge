        ...
        <div className="content">
          ...
          {view === "new" && <section className="composer panel">
            ...
            <div className="composer-options">
              ...
              <span className="mode-hint">Automatic discovery runs up to five planned searches, reviews source matches, and tries up to five pages per run, with one bounded recovery search. You can provide up to five URLs; each run tries at most five.</span>
            </div>
